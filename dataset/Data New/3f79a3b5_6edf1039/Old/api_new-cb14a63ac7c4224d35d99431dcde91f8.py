...
class API(base.Base):
    ...
    def _checks_for_create_and_rebuild(self, context, metadata,
                                       files_to_inject):
    ...
    def _create_instance(self, context, instance_type,
        ...
        self._checks_for_create_and_rebuild(context, metadata, injected_files)
        self._validate_flavor_image(context, image_id, boot_meta,
                                    instance_type,
    ...
    def rebuild(self, context, instance, image_href, admin_password,
        ...
        self._checks_for_create_and_rebuild(context, metadata, files_to_inject)
        self._validate_flavor_image(context, image_id, image, flavor, root_bdm)
