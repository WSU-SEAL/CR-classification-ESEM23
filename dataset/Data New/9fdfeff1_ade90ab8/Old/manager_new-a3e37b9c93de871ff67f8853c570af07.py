...
class ComputeManager(manager.Manager):
    ...
    def _post_live_migration(self, ctxt, instance, dest,
        ...
        # destination node
        with utils.lock(resource_tracker.COMPUTE_RESOURCE_SEMAPHORE):
            self.rt.pci_tracker.free_instance_allocations(ctxt, instance)
    ...
    def post_live_migration_at_destination(self, context, instance,
        ...
        with utils.lock(resource_tracker.COMPUTE_RESOURCE_SEMAPHORE):
            self.rt.pci_tracker.allocate_instance(instance)
    ...
    def rollback_live_migration_at_destination(self, context, instance,
        ...
        try:
            ...
            with utils.lock(resource_tracker.COMPUTE_RESOURCE_SEMAPHORE):
                self.rt.pci_tracker.free_instance_claims(context, instance)
    ...
    def _claim_pci_for_instance_vifs(self, ctxt, instance):
        ...
        if pci_reqs:
            ...
            vif_pci_requests = instance_pci_requests_obj.InstancePCIRequests(
                ...
                instance_uuid=instance.uuid)
            with utils.lock(resource_tracker.COMPUTE_RESOURCE_SEMAPHORE):
                claimed_pci_devices_objs = self.rt.pci_tracker.claim_instance(
