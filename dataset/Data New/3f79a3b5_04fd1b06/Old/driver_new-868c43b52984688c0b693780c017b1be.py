...
class LibvirtDriver(driver.ComputeDriver):
    ...
    def cleanup(self, context, instance, network_info, block_device_info=None,
        ...
        # FIXME(lyarwood): Remove the following evacuation cleanup workaround
        # for rbd once the compute and virt layers are able to differentiate
        # between instance disk storage
        # and any additional instance storage during cleanup.
        if ((destroy_disks or is_shared_block_storage) or
            (CONF.libvirt.images_type == 'rbd' and
             CONF.workarounds.ensure_libvirt_evac_instance_dir_cleanup_rbd and
