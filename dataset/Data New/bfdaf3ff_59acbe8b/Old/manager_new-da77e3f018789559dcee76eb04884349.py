...
class ComputeManager(manager.Manager):
    ...
    def reset(self):
        ...
        self.compute_rpcapi = compute_rpcapi.ComputeAPI()
        self.rt.reportclient.clear_provider_cache()
    ...
    def _complete_deletion(self, context, instance):
        ...
        self.rt.reportclient.delete_allocation_for_instance(context,
                                                            instance.uuid)
    ...
    def _build_resources(self, context, instance, requested_networks,
        ...
        try:
            resources['allocations'] = (
                self.rt.reportclient.get_allocations_for_consumer(
                    context, instance.uuid))
        except Exception:
    ...
    def _do_rebuild_instance(self, context, instance, orig_image_ref,
        ...
        allocations = self.rt.reportclient.get_allocations_for_consumer(
            context, instance.uuid)
    ...
    def _revert_allocation(self, context, instance, migration):
        ...
        orig_alloc = self.rt.reportclient.get_allocations_for_consumer(
            context, migration.uuid)
        if not orig_alloc:
        ...
        self.rt.reportclient.move_allocations(context, migration.uuid,
                                              instance.uuid)
        return True
    ...
    def update_available_resource(self, context, startup=False):
        ...
        for cn in compute_nodes_in_db:
            if cn.hypervisor_hostname not in nodenames:
                ...
                self.rt.reportclient.delete_resource_provider(context, cn,
                                                              cascade=True)
