...
``live_migration_timeout_action`` is set to 'force_complete' and we reach
the timeout defined by ``live_migration_completion_timeout``. Note if you
change to not timeout, i.e. ``live_migration_completion_timeout = 0``,
then there will be no automatic switch to post-copy.
