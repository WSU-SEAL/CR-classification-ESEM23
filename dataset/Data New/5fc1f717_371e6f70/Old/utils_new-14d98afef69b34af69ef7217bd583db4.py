...
def get_ksa_adapter_opts(default_service_type, deprecated_opts=None):
    ...
    """
    # NOTE(gyee): we still need to include the deprecated 'interface' option
    # as ironicclient, and possibly others, still depends on it.
    opts = ks_loading.get_adapter_conf_options(include_deprecated=True,
