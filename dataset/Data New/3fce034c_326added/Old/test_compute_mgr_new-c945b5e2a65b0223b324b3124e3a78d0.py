...
class ComputeManagerUnitTestCase(test.NoDBTestCase,
    ...
    def test__require_nw_info_update_for_baremetal(self):
        """Tests _require_nw_info_update for baremetal instance,
        expected behavior is not to change port binding info.
        """
        compute_mgr = manager.ComputeManager('ironic.IronicDriver')
        with mock.patch.object(compute_mgr, 'network_api') as \
                network_api_mock:
            compute_mgr._require_nw_info_update(self.context, None)
