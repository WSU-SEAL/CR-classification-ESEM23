    ...
    def obj_load_attr(self, attrname):
        if attrname == 'user_id':
            ...
            raise exception.ObjectActionError(
                ...
                reason=_('attribute user_id not lazy-loadable'))
...
def populate_user_id(context, max_count):
    ...
    ims = (
        ...
        # queued_for_delete=True because they include SOFT_DELETED
        # instances, which could be restored at any time in the future.
        # If we don't migrate SOFT_DELETED instances now, we wouldn't
