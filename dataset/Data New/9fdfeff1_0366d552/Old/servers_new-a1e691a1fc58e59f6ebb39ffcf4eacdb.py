...
class ServersController(wsgi.Controller):
    ...
    def _get_servers(self, req, is_detail):
        ...
        # if it's present unless we support handling down cells in which case
        # we need to know further down the stack whether the 'all-tenants'
        # filter was passed with the true value or not. We pop this option in
        # the compute API if its value is true.
