...
class VlanNetworkTestCase(test.TestCase):
    ...
    def test_vpn_allocate_fixed_ip(self, mock_change_ip, mock_address_command,
                                   mock_lookup_ip, mock_routes_show,
    ...
    @mock.patch('nova.privsep.linux_net.address_command_horrid')
    @mock.patch('nova.privsep.linux_net.change_ip')
    def test_allocate_fixed_ip(self, mock_change_ip, mock_address_command,
    ...
    def test_add_fixed_ip_instance_without_vpn_requested_networks(
            self, mock_change_ip, mock_address_command, mock_lookup_ip,
...
class AllocateTestCase(test.TestCase):
    ...
    @mock.patch('nova.privsep.linux_net.address_command_horrid')
    @mock.patch('nova.privsep.linux_net.change_ip')
    def test_allocate_for_instance(self, mock_change_ip, mock_address_command,
                                   mock_lookup_ip, mock_routes_show,
                                   mock_unbind, mock_bind, mock_set_macaddr,
