    ...
    def test__claim_pci_for_instance_vifs(self):
        ...
        def _test(mock_get_network_info,
            ...
            port_id_to_pci = self.compute._claim_pci_for_instance_vifs(
                self.context,
                self.instance)
            rt_mock.pci_tracker.claim_instance.assert_not_called()
            ...
            claimed_pci_dev = objects.PciDevice(request_id=uuids.pci_req,
                                                ...
                                                vendor_id='15b3',
                                                product_id='1018')
            rt_mock.pci_tracker.claim_instance.return_value = [claimed_pci_dev]
            ...
            self.assertTrue(rt_mock.pci_tracker.claim_instance.called)
