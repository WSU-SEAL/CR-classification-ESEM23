...
class ComputeManagerUnitTestCase(test.NoDBTestCase,
    ...
    def test__heal_instance_info_cache_for_baremetal(self):
        """Tests _heal_instance_info_cache for baremetal instance,
        expected behavior is not to change port binding info.
        """
        CONF.set_default('compute_driver', 'ironic.IronicDriver')
        with mock.patch.object(self.compute, 'network_api') as \
                network_api_mock:
            self.compute._heal_instance_info_cache(self.context)
