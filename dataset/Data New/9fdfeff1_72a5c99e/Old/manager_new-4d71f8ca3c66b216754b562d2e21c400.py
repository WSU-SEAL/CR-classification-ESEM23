...
class ComputeManager(manager.Manager):
    ...
    def _get_request_group_mapping(self, request_spec):
        """Return request group resource - provider mapping. This is currently
        used for Neutron ports that has resource request due to the port has
        QoS minimum bandwidth policy rule attached.

        :param request_spec: A RequestSpec object
        :returns: A dict keyed by RequestGroup requirest id, currently Neutron
