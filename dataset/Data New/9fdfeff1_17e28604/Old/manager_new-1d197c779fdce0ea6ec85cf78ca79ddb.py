...
class ComputeManager(manager.Manager):
    ...
    def _post_live_migration(self, ctxt, instance,
        ...
        # TODO(adrianc): Check if the pci_tracker is always initialized.
        if pci_tracker:
            pci_tracker.free_instance_allocations(
                ctxt,
                instance)
    ...
    def rollback_live_migration_at_destination(self, context, instance,
        ...
        try:
            ...
            # TODO(adrianc): Check if the pci_tracker is always initialized.
            if pci_tracker:
                pci_tracker.free_instance_claims(
                    context,
                    instance)
    ...
    def _claim_pci_for_instance_vifs(self, ctxt, instance):
        ...
        for vif in instance.get_network_info():
            pci_req = pci_request.get_instance_pci_request_from_vif(
                ctxt,
                instance,
                vif)
            if pci_req:
