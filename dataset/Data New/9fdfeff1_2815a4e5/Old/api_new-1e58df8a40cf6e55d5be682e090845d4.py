...
class API(base.Base):
    ...
    def resize(self, context, instance, flavor_id=None, clean_shutdown=True,
        ...
        # We are not checking image status and root_bdm since image/volume are
        # not changed during resize.
        image['status'] = 'active'
        self._validate_flavor_image(context, '', image, new_instance_type,
                                    None)
