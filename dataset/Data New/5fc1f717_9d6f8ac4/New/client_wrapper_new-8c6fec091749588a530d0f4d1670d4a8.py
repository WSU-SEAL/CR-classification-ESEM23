...
class IronicClientWrapper(object):
    ...
    def _get_client(self, retry_on_conflict=True):
        ...
        # NOTE(gyee): 'valid_interfaces' is default to ['internal', 'public']
        # so it is always set unless explicitly unset in the config file.
        # Also, 'interface' is deprecated in KSA so we should always be
        # using 'valid_interfaces' whenever possbile.
        kwargs['interface'] = (ironic_conf.valid_interfaces or
            ironic_conf.interface)
