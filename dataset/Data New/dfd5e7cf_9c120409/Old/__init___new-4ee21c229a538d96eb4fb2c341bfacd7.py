...
class BaseHostFilter(filters.BaseFilter):
    ...
    def host_limits_update(self, host_state, filter_properties):
        """Update the host_state.limits parameter. Override this in a
        subclass, if the subclass does need to update, just pass.
        """
        pass
