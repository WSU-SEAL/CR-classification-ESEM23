...
class ComputeTaskManager(base.Base):
    ...
    @staticmethod
    def _set_user_id_in_instance_mapping(mapping, instance):
        # If we are in the middle of an upgrade, populate user_id once we know
        # the cell.
    ...
    def _populate_instance_mapping(self, context, instance, host):
        try:
            ...
            try:
                ...
                self._set_user_id_in_instance_mapping(inst_mapping, instance)
                inst_mapping.save()
        return inst_mapping
        ...
        for instance in instances_by_uuid.values():
            with obj_target_cell(instance, cell0) as cctxt:
                ...
                try:
                    ...
                    self._set_user_id_in_instance_mapping(inst_mapping,
                                                          instance)
                    inst_mapping.save()
                except exception.InstanceMappingNotFound:
                    pass
