    ...
    def weight_multiplier(self, host_state):
        ...
        if value < 0 and not self.warning_sent:
            LOG.warning('For the soft_affinity_weight_multiplier only a '
                        ...
                        'file and aggregate metadata to mitigate future '
                        'upgrade issues.')
    ...
    def weight_multiplier(self, host_state):
        ...
        if value < 0 and not self.warning_sent:
            LOG.warning('For the soft_anti_affinity_weight_multiplier '
                        ...
                        'configuration file and aggregate metadata to mitigate'
