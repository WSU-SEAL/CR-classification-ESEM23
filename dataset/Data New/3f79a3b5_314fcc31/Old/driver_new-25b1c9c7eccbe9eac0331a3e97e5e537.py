...
class LibvirtDriver(driver.ComputeDriver):
    ...
    def cleanup(self, context, instance, network_info, block_device_info=None,
        ...
        # when using the shared RBD imagebackend.
        # This workaround is not required when cleaning up migrations that
        # provide migrate_data as the existing is_shared_block_storage
        # conditional will cause the instance directory to be removed correctly
        # in such cases.
