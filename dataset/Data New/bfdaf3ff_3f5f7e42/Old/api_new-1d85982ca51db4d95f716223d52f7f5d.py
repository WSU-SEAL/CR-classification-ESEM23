...
class API(base.Base):
    ...
    def _validate_numa_topology(self, instance_type, image):
        try:
        ...
        return hardware.numa_get_constraints(instance_type, image_meta)
    ...
    def _validate_flavor_image(self, context, image_id, image,
        ...
        hardware._get_cpu_topology_constraints(instance_type, image_meta)
    ...
    def _validate_and_build_base_options(self, context, instance_type,
        ...
        numa_topology = self._validate_numa_topology(instance_type, boot_meta)
    ...
    def rebuild(self, context, instance, image_href, admin_password,
        ...
        self._validate_numa_topology(flavor, image)
        ...
        if not flavor_id:
            ...
            if new_instance_type:
                ...
                if is_volume_backed:
                    ...
                    volume_image_metadata = volume.get('volume_image_metadata',
                                                       {})
                    image_ref = volume_image_metadata.get('image_id')
                else:
                    image_ref = instance.image_ref
                image_id, image = self._get_image(context, image_ref)
                self._validate_numa_topology(new_instance_type, image)
                self._validate_flavor_image(context, image_id, image,
                                            new_instance_type, root_bdm)
