        ...
        def catch_all():
            ...
            * Except ResourceProviderUpdateConflict, which signals the caller
            ...
            try:
                ...
                # Invalidate the cache and reraise the conflict exception. This
                # signals the resource tracker to redrive the update right away
                # rather than waiting until the next periodic.
