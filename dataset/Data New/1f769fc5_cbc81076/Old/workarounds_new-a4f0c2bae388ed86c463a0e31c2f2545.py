...
Both of these bugs can then result in DestinationDiskExists errors being raised
if the instances ever attempt to return to the host.

.. warning:: Operators will need to ensure that the instance directory itself
  is not shared between computes before enabling this workaround otherwise the
