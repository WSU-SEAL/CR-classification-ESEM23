...
class FakeMdevTypeDevice(object):
    template = """
    <device>
    ...
    def __init__(self, type_id):
        self.xml = self.template % {'type_id': type_id}
...
class HostMdevDevicesInfo(object):
    ...
    def get_device_types(self):
        return [FakeMdevTypeDevice(NVIDIA_11_VGPU_TYPE)]
  ...
  <guest>
    ...
    def listDevices(self, cap, flags):
        ...
        if cap == 'mdev_types':
            ...
            # did not work for me.
            return self.mdev_info.get_device_types()
        else:
