...
"""),
    ...
    cfg.StrOpt(
        ...
        max_length=255,
        regex=r'^[a-zA-Z0-9_\-\.]*$',
        help='Limit the set of nodes that may be managed by this service '
             'to the set of nodes in Ironic which have a matching '
             'conductor_group property. If unset, all available nodes may '
             'be managed by this service.'),
    cfg.ListOpt(
        'peer_list',
        default=[],
        mutable=True,
