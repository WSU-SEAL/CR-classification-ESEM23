...
from nova.objects import instance_pci_requests as pci_req_obj
...
class ComputeManager(manager.Manager):
    ...
    def _free_instance_allocations(self, context, instance):
        """Free instance allocated PCI resources

        :param context: security context
        :param instance: instance dict
        """
        self.rt.pci_tracker.free_instance_allocations(context, instance)
        self.rt.pci_tracker.save(context)

    @utils.synchronized(resource_tracker.COMPUTE_RESOURCE_SEMAPHORE)
    def _allocate_instance_claims(self, context, instance):
        """Allocate instance claimed PCI resources

        :param context: security context
        :param instance: instance dict
        """
        self.rt.pci_tracker.allocate_instance(context, instance)
        self.rt.pci_tracker.save(context)

    @utils.synchronized(resource_tracker.COMPUTE_RESOURCE_SEMAPHORE)
    def _claim_vif_pci_devices(self, context, vif_pci_requests):
        """Cliam instance PCI resources for vifs

        :param context: security context
        :param vif_pci_requests: a list of nova.objects.InstancePCIRequests
        :returns: a list of nova.objects.PciDevice objects
        """
        result = self.rt.pci_tracker.claim_instance(
            context, vif_pci_requests, None)
        self.rt.pci_tracker.save(context)
        return result
    ...
    def _post_live_migration(self, ctxt, instance, dest,
        ...
        # destination node
        self._free_instance_allocations(ctxt, instance)
    ...
    def post_live_migration_at_destination(self, context, instance,
        ...
        self._allocate_instance_claims(context, instance)
    ...
    def rollback_live_migration_at_destination(self, context, instance,
        ...
        try:
            ...
            self._free_instance_allocations(context, instance)
    ...
    def _claim_pci_for_instance_vifs(self, ctxt, instance):
        ...
        if pci_reqs:
            ...
            # source node.
            vif_pci_requests = pci_req_obj.InstancePCIRequests(
                requests=pci_reqs,
                instance_uuid=instance.uuid)

            claimed_pci_devices_objs = self._claim_vif_pci_devices(
                ctxt, vif_pci_requests)
