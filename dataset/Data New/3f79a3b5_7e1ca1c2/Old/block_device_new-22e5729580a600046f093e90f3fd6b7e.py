...
class BlockDeviceMapping(base.NovaPersistentObject, base.NovaObject,
    ...
    # Version 1.21: Add get_root_bdm_by_instance() and
    #               cleanup_fields_for_root_bdm()
    VERSION = '1.21'
    ...
    @base.remotable_classmethod
    def get_root_bdm_by_instance(cls, context, instance_uuid):
        root_bdm = db.block_device_mapping_get_root_by_instance(
            context, instance_uuid)
        if not root_bdm:
            raise exception.RootVolumeBDMNotFound(instance_uuid=instance_uuid)
        return cls._from_db_object(context, cls(), root_bdm)
    ...
    def cleanup_fields_for_root_bdm(self):
        self.volume_id = None
