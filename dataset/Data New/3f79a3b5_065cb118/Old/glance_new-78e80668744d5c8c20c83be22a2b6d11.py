...
class GlanceClientWrapper(object):
    ...
    def _create_static_client(self, context, endpoint):
        """Create a client that we'll use for every call."""
        self.api_server = str(endpoint)
        return _glanceclient_from_endpoint(
            context, endpoint, self.IMAGE_API_VERSION)
    ...
    def _create_onetime_client(self, context):
        ...
        return _glanceclient_from_endpoint(
            context, self.api_server, self.IMAGE_API_VERSION)

    def call(self, __client_context, __client_method, *args, **kwargs):
        ...
        for attempt in range(1, num_attempts + 1):
            ...
            try:
                ...
                result = getattr(controller, __client_method)(*args, **kwargs)
                ...
                LOG.exception("Error contacting glance server "
                              ...
                              {'server': self.api_server,
                               'method': __client_method, 'extra': extra})
                if attempt == num_attempts:
...
class GlanceImageServiceV2(object):
    ...
    def _add_location(self, context, image_id, location):
        ...
        try:
            return self._client.call(context, 'add_location', image_id,
                                     location, {})
    ...
    def _upload_data(self, context, image_id, data):
        ...
        return self._client.call(context, 'get', image_id)
    ...
    def _get_image_create_disk_format_default(self, context):
        ...
        image_schema = self._client.call(context, 'get', 'image',
                                         controller='schemas')
    ...
    def _update_v2(self, context, sent_service_image_meta, data=None):
        ...
        image = self._client.call(
            context, 'update', **sent_service_image_meta)
