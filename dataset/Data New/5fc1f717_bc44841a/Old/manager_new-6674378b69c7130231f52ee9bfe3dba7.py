    ...
    def _validate_instance_group_policy(self, context, instance,
        ...
        def _do_validation(context, instance, group_hint, migration):
            ...
            if group.policy and 'anti-affinity' == group.policy:
                ...
                if migration:
                    mgs_same_host_and_node = objects.MigrationList. \
                        get_in_progress_by_host_and_node(
                            context, host=migration.dest_compute,
                            node=migration.dest_node)
                    ins_uuids = [mgs.instance_uuid
                                 for mgs in mgs_same_host_and_node]
                    members_on_host = set(list(members_on_host) + ins_uuids) \
