...
class SchedulerReportClient(object):
    ...
    def clear_provider_cache_for_tree(self, rp_uuid):
        ...
        """
        try:
            uuids = self._provider_tree.get_provider_uuids(
                rp_uuid, whole_tree=True)
        except ValueError:
            ...
            * Except ResourceProviderUpdateConflict, which signals the caller
            ...
            try:
                ...
                with excutils.save_and_reraise_exception():
                    self.clear_provider_cache_for_tree(rp_uuid)
