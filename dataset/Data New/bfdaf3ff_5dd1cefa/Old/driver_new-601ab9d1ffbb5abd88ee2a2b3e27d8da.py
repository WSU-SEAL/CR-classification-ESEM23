...
class LibvirtDriver(driver.ComputeDriver):
    ...
    def _get_guest_config_sysinfo(self, instance, use_unique_serial=False):
    ...
    def _configure_guest_by_virt_type(self, guest, virt_type, caps, instance,
        ...
        if virt_type == "xen":
            ...
            if caps.host.cpu.arch in (fields.Architecture.I686,
                                      fields.Architecture.X86_64):
                use_unique_serial = False
                if (image_meta.properties.get('hw_unique_serial', None) or
                        flavor.extra_specs.get('hw:unique_serial', None) or
                        CONF.libvirt.sysinfo_serial == 'unique'):
                    use_unique_serial = True
                guest.sysinfo = self._get_guest_config_sysinfo(
                    instance, use_unique_serial)
