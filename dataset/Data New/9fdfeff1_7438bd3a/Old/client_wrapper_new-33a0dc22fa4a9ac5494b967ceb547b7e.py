...
class IronicClientWrapper(object):
    ...
    def _get_client(self, retry_on_conflict=True):
        ...
        # FIXME(gyee): even though 'interface' had been deprecated in favor of
        # 'valid_interfaces' in KSA, the session adapter in ironicclient is
        # still using 'interface' for endpoint lookups. We'll need to update
        # this code after we modernize ironicclient.
