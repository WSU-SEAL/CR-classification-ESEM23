...
class HostManagerTestCase(test.NoDBTestCase):
    ...
    def test_get_compute_nodes_by_host_or_node(self,
        ...
        cn1 = objects.ComputeNode(host='fake_multihost', node='fake-node1')
        cn2 = objects.ComputeNode(host='fake_multihost', node='fake-node2')
        cn3 = objects.ComputeNode(host='fake_host1', node='fake-node')
        mock_get_all.return_value = objects.ComputeNodeList(objects=[cn1, cn2])
