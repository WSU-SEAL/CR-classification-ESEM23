...
class ComputeManager(manager.Manager):
    ...
    def _require_nw_info_update(self, context, instance):
        ...
        ports.
        """
        # Only update port bindings if the virt driver is not allowed
        # to do so, for example IronicDriver manages the port binding
        # for baremetal instance ports, hence, external intervention
        # with the binding is not desired.
        if self.driver.manages_port_bindings():
            return False
