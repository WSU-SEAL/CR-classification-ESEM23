...
class API(base_api.NetworkAPI):
    ...
    def deallocate_port_for_instance(self, context, instance, port_id):
        ...
        :return: A NetworkInfo, port_allocation tuple, where the
                 port_allocation is a dict contains the resource allocation of
                 the port per resource provider uuid. E.g.:
                 {
                     rp_uuid: {
                 ...
                 neutron port only allocation from a single resource provider.
        """
        neutron = get_client(context)
        ...
        allocated_rp = port.get(BINDING_PROFILE, {}).get('allocation', None)
