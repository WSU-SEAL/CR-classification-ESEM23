...
class ConfigurableMaxDiskDevicesTest(integrated_helpers.InstanceHelperMixin,
    ...
    def test_boot_from_volume_plus_attach_fail(self):
        ...
        expected = ('Build of instance %s aborted: Failure prepping block '
                    'device. The maximum allowed number of disk devices: 1 to '
    ...
    def test_attach(self):
        ...
        self.assertIn(expected, ex.response.text)
