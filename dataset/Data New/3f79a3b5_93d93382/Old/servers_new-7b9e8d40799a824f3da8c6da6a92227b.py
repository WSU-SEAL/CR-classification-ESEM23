...
when the requesting tenant already has other active servers in down cells
whose quota cannot be correctly obtained and would be skipped, thus later
...
will be blocked from server creation unless the rule is changed to state
otherwise.
""",
        [
            {
