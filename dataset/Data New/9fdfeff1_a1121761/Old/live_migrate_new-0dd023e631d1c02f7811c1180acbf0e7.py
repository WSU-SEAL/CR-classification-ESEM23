...
class LiveMigrationTask(base.TaskBase):
    ...
    def _execute(self):
        ...
        # NOTE(artom) Set the source now. The destination nodename and host
        # will be set when we call check_can_live_migrate_destination(): it'll
        # create a MoveClaim, which will call _claim_existing_migration() in
        # the resource tracker, which will set the destination nodename and
        # host.
