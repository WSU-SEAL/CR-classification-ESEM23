...
class RequestGroup(base.NovaObject):
    ...
    fields = {
        ...
        # The resource provider uuids that together fulfilling the request
        # NOTE(gibi): this can be more than one if this is the un numbered
        # request group (i.e. use_same_provider=False)
        'provider_uuids': fields.ListOfStringsField(default=[]),
    }
